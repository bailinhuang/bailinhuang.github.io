...
class TypeWriter {
	...
	showTypingMessage () {
	  ...
	  const fullTxt = this.words[current].title;
	  ...
	  if (this.wordIndex !== this.words.length) {
		return setTimeout(() => this.showTypingMessage(), typeSpeed);
	  } else{
  ...
  const init = () => {
	...
	const words = 
	[
		{title: 'Hello, traveler', message: 'Welcome to my dimension'}, 
